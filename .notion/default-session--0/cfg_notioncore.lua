...
-- Launcing different terminals
defmenu("terminalsmenu", {
...
defmenu("externalmonitormenu", {
    menuentry("Turn it off",        "mod_query.query_exec(_, 'xrandr --output LVDS1 --auto --output VGA1 --off')"),
    menuentry("VGA1 above",         "mod_query.query_exec(_, 'xrandr --output eDP1 --auto --primary --output VGA1 --auto --above eDP1')"),
    menuentry("VGA1 on the right",  "mod_query.query_exec(_, 'xrandr --output eDP1 --auto --primary --output VGA1 --auto --right-of eDP1')"),
    menuentry("Fix dualhead",       "mod_query.query_exec(_, 'xrandr --output VGA1 --below LVDS1 && xrandr --output VGA1 --auto && xrandr --output LVDS1 --auto')"),
})
...
defmenu("sessionmenu", {
    ...
    menuentry("Restart e17",    "ioncore.restart_other('enlightenment_start')"),
